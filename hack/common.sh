...
packages() {
  echo "./cmd/cluster-controller/ ./cmd/machine-controller/ ./cloud/maas/actuators/cluster\
   ./cloud/maas/actuators/machine ./cloud/maas/controllers/cluster ./cloud/maas/controllers/machine"
}
