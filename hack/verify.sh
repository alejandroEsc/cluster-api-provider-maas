...
ret=0
echo "${ROOT}"
run-check "${ROOT}/hack/verify-go-vet.sh" bash
run-check "${ROOT}/hack/verify-gofmt.sh" bash
run-check "${ROOT}/hack/verify-goimports.sh" bash
run-check "${ROOT}/hack/verify-golint.sh" bash
